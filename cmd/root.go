...
var rootCmd = &cobra.Command{
	Use:   "gcp-lb-tags",
	Short: "maintains a TCP loadbalancer based on instance labels",
	Long: `Creates and maintains loadbalancers in google cloud based on
	labels assigned to instances.:`,
